#### MAP (function, list) пераброзовует filter(function, list) - изменяет список reduce(function. list, 0/1)
###      srt\int\sum                          str\int\sum\max
...
print(sum(map(square, filter(add, numbers))))
